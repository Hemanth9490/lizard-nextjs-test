    ...
    >
      <div className="flex cursor-pointer rounded border border-slate-200 px-6 py-5 hover:bg-slate-50">
        <div className="flex flex-1 items-center gap-4">
          <div className="max-w-xs rounded-md bg-brand-50 p-4">
            <svg viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className="bg-brand-50 text-brand-500 h-12 w-12">
